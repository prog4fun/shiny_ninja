...
class UsersController < ApplicationController
  ...
  def user_params
    params.require(:user).permit(:city, :comment, :confirmed_at, :country, :email, :firstname, :lastname, :login, :password, :password_confirmation, :phone_number, :remember_me, :roles_mask, :signature, :street, :street_number, :zipcode, :roles => [])
  end
